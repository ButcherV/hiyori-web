...
export const HIRAGANA_SEION: Record<string, HiraganaSeion> = {
  ...
  と: defineHSeion({
    ...
    wordKana: 'とけい',
    wordRomaji: 'to·ke·i',
    wordMeaning: { en: 'clock', zh: '钟；表', zhHant: '鐘；錶' },
    wordEmoji: '🕓',
  ...
  の: defineHSeion({
    ...
    wordMeaning: { en: 'beverage; drink', zh: '饮料', zhHant: '飲料' },
    wordEmoji: '🥤',
    kanaDistractors: ['め', 'ぬ', 'あ'],
    romajiDistractors: ['mo', 'nu', 'na'],
    wordDistractors: ['めみもの', 'ぬみもの', 'のもみの', 'のみみの'],
  }),
  ...
  ま: defineHSeion({
    ...
    wordKana: 'まち',
    wordRomaji: 'ma·chi',
    wordMeaning: { en: 'town', zh: '小镇', zhHant: '小鎮' },

    wordEmoji: '🏘️',
    kanaDistractors: ['ほ', 'は', 'よ'],
    romajiDistractors: ['mo', 'na', 'ho'],
    wordDistractors: ['まき', 'まさ', 'かち'],
  }),
