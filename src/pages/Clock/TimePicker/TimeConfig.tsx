...
// 时刻课程说明组件
const TimeDescription: React.FC = () => {
    ...
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.sectionContent}>
          <p className={styles.text}>
            <Trans
              i18nKey="clock_study.time_course.goal_desc"
              components={{
      ...
      <div className={styles.section}>
        ...
        <div className={styles.sectionContent}>
          <div className={styles.text}>
            <Trans
              i18nKey="clock_study.time_course.special_pronunciation_desc"
              components={{
      ...
      <div className={styles.section}>
        ...
        <div className={styles.sectionContent}>
          <div className={styles.text}>
            <Trans
              i18nKey="clock_study.time_course.interaction_desc"
              components={{
                strong: <strong className={styles.strong} />,
                br: <br />,
                span: <span className={styles.highlight} />,
...
// 时刻课程配置
export const TIME_CONFIG: ClockLessonConfig = {
  id: 'time',
  labelKey: 'clock_study.time_label',
  titleKey: 'clock_study.time_title',
  DescriptionContent: TimeDescription,
};
